...
4) To get the actual response from the file locations run lucene_ref_generator.ipynb. This does some checks to ensure responses from the same dialogue aren't picked up as reference documents for the training dataset.
